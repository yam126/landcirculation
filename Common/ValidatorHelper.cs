...
namespace Common
{
    ...
    public class ValidatorHelper
    {
        ...
        /// 验证身份证是否有效
        /// </summary>
        /// <param name="Id">要验证的身份证字符串</param>
        /// <returns>是否身份证</returns>
        ...
        /// 验证是否float
        /// </summary>
        /// <param name="strNumber">字符串类型</param>
        /// <returns>验证结果</returns>
        public static bool IsFloat(string strNumber)
        {
            float test = 0;
            return float.TryParse(strNumber, out test);
        }
        #endregion
